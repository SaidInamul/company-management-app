    ...
    <div class="max-w-6xl flex flex-col space-y-3 mx-auto p-6">
        <div class="flex justify-between items-center mb-14">
            <div class="flex space-x-4 items-center">
                ...
                <h1 class="font-medium text-2xl">Edit Company : {{ $company->name }}</h1>
            </div>
            
            <a href="{{ route('index.update', $company->id) }}"
        ...
        <form id="update-form" action="{{ route('index.update', $company->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
